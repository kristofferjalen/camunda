    ...
    ProcessValidationUtil.assertThatProcessHasViolations(
        ...
        expect(
            ...
            "Execution listeners are not supported for the 'sequenceFlow' element. "
                ...
                + "scriptTask, userTask, receiveTask, businessRuleTask, manualTask, startEvent, intermediateThrowEvent, intermediateCatchEvent, endEvent] elements can have execution listeners."));
  }
