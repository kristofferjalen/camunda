...
public class ListViewFromJobHandler implements ExportHandler<FlowNodeInstanceForListViewEntity, JobRecordValue> {
  ...
  private static final Set<String> FAILED_JOB_EVENTS = Set.of(JobIntent.FAIL.name(), JobIntent.FAILED.name());
  ...
  public ListViewFromJobHandler(ListViewTemplate listViewTemplate, BatchRequest batchRequest, boolean concurrencyMode) {
  ...
  @Override
  public void updateEntity(Record<JobRecordValue> record, FlowNodeInstanceForListViewEntity entity) {
